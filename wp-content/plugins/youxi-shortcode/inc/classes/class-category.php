...
/**
 * Youxi Shortcode Category class
 *
 * This class groups a set of shortcodes into a category.
 *
 * @package   Youxi Shortcode
 * @author    Mairel Theafila <maimairel@yahoo.com>
 * @copyright Copyright (c) 2013-2016, Mairel Theafila
 */
if( ! class_exists( 'Youxi_Shortcode_Category' ) ) :

	final class Youxi_Shortcode_Category {
