...
;(function( $, window, document ) {
	...
	$.extend( Helium, window._helium || {}, {
		...
		setup: function( context ) {
			...
			if( context && $.Youxi && $.Youxi.Shortcode ) {
				$.Youxi.Shortcode.setup( context );
			}
			...
			if( context ) {
				...
				if( window.WPPlaylistView ) {

					$( '.wp-playlist', context ).each( function() {
