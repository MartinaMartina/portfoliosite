	...
	function helium_add_portfolio_metabox() {
		...
		$metaboxes['portfolio_grid_settings'] = array(
			...
			'fields' => array(
				...
				'filter_orderby' => array(
					'type' => 'select', 
					'label' => esc_html__( 'Filter Order By', 'helium' ), 
					'description' => esc_html__( 'Choose the field to order the portfolio filter terms by.', 'helium' ), 
					'choices' => array(
						'count'   => esc_html__( 'Term Count', 'helium' ), 
						'name'    => esc_html__( 'Term Name', 'helium' ), 
						'slug'    => esc_html__( 'Term Slug', 'helium' ), 
						'term_id' => esc_html__( 'Term ID', 'helium' )
					), 
					'std' => 'name', 
					'criteria' => 'use_defaults:is(0),show_filter:is(1)'
				), 
				'filter_order' => array(
					'type' => 'select', 
					'label' => esc_html__( 'Filter Order', 'helium' ), 
					'description' => esc_html__( 'Choose whether to order the portfolio filter terms in ascending or descending order.', 'helium' ), 
					'choices' => array(
				...
				'meta_text' => array(
					...
					'description' => esc_html__( 'Specify the text to show below them portfolio title.', 'helium' ), 
					'choices' => array(
