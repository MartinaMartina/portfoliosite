...
Changelog:
1.4.2 - 14/12/2016
- Updated the portfolio taxonomy arguments

1.4.1 - 28/09/2016
- Youxi Core 1.6 compatibility
- Refactor the way portfolio post type is registered

1.4 - 25/04/2016
- Portfolio and portfolio category slug can now be adjusted in Settings > Permalinks
- Post type now supports comments and excerpt by default
- Taxonomy is now hierarchical by default
...
function youxi_portfolio_plugins_loaded() {
	...
	define( 'YOUXI_PORTFOLIO_VERSION', '1.4.2' );
	...
	require_once( YOUXI_PORTFOLIO_DIR . 'class-portfolio-permalinks.php' );
