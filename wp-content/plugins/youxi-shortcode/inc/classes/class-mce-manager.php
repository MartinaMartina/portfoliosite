...
/**
 * Youxi Shortcode TinyMCE Manager class
 *
 * This class integrates the shortcode editor into WordPress' TinyMCE editor.
 *
...
if( ! class_exists( 'Youxi_Shortcode_TinyMCE_Manager' ) ) :
	...
	final class Youxi_Shortcode_TinyMCE_Manager {
		...
		public function admin_enqueue_scripts( $hook ) {
			...
			*/
			if( ( 'post.php' != $hook && 'post-new.php' != $hook ) || ! post_type_supports( get_post_type(), 'editor' ) ) {
				return;
			}
		...
		public function mce_external_plugins( $plugins ) {
			...
			$plugins['youxishortcode'] = YOUXI_SHORTCODE_URL . "assets/admin/tinymce/plugin{$suffix}.js";
			return $plugins;
		}
		...
		public function shortcode_js_vars( $vars ) {
			$vars['tinyMCEL10N'] = array(
				'shortcodeButtonTitle' => esc_html__( 'Insert Shortcode', 'youxi' )
			);	
			$vars['defaultContent'] = esc_html__( 'Content here', 'youxi' );
