	...
	class Youxi_Gallery_Form_Field extends Youxi_Form_Field {
		...
		public function enqueue( $hook ) {
			...
			if( parent::enqueue( $hook ) ) {
				...
				wp_enqueue_script( 'youxi-gallery', self::field_assets_url( "js/youxi.form.gallery{$suffix}.js" ), array( 'youxi-form-manager', 'media-editor', 'jquery-ui-widget' ), YOUXI_CORE_VERSION, true );
				wp_enqueue_style( 'youxi-gallery', self::field_assets_url( "css/youxi.form.gallery{$suffix}.css" ), array( 'youxi-form' ), YOUXI_CORE_VERSION );
...
<?php
		...
		public function sanitize( $data ) {
			...
			return array_filter( $data, 'wp_attachment_is_image' );
		}
				...
				$o .= '<div class="youxi-gallery-previews">';
					...
					foreach( $value as $attachment_id ): 
						...
						$o .= '<div class="youxi-gallery-preview-item">';
							...
							$o .= '<input type="hidden" name="' . $this->get_the_name() . '[]" class="youxi-gallery-value" value="' . esc_attr( $attachment_id ) . '">';
