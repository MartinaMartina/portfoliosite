...
Changelog:
2.0 - 18/05/2016
- NEW: Leaflet Map widget
- Improvement: Deprecate Google Maps widget
- Improvement: Deprecate Recent Posts widget
...
define( 'YOUXI_WIDGETS_VERSION', '2.0' );
...
function youxi_widgets_init() {
	...
	if( apply_filters( 'youxi_widgets_use_leaflet', true ) ) {
		if( ! class_exists( 'Youxi_Leaflet_Map_Widget' ) ) {
			require( YOUXI_WIDGETS_DIR . 'class-widget-leaflet.php' );
		}
		register_widget( 'Youxi_Leaflet_Map_Widget' );
	}
