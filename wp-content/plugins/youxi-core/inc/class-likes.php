	...
	final class Youxi_Likes {
		...
		public static function get_link_attributes( $post_id, $attr = array(), $liked_attr = array() ) {
			...
			$attr = array_merge( $attr, array(
				...
				'data-likes-ajax-action' => 'youxi_add_likes', 
		...
		public static function enqueue() {
			...
			wp_enqueue_script( 'youxi-likes', YOUXI_CORE_URL . "frontend/assets/js/youxi.likes{$suffix}.js", array( 'jquery' ), YOUXI_CORE_VERSION, true );
		}
...
add_action( 'wp_ajax_youxi_add_likes', array( 'Youxi_Likes', 'ajax_add_like' ) );
add_action( 'wp_ajax_nopriv_youxi_add_likes', array( 'Youxi_Likes', 'ajax_add_like' ) );
