...
function helium_edd_button_colors( $button_colors ) {
	return array(
		'turquoise'   => array(
			'label' => esc_html__( 'Turquoise', 'helium' ),
			'hex'   => '#3dc9b3'
		),
		'white'   => array(
			'label' => esc_html__( 'White', 'helium' ),
			'hex'   => '#fff'
		),
		'blue'      => array(
			'label' => esc_html__( 'Blue', 'helium' ),
			'hex'   => '#428bca'
		),
		'red'       => array(
			'label' => esc_html__( 'Red', 'helium' ),
			'hex'   => '#d9534f'
		),
		'green'     => array(
			'label' => esc_html__( 'Green', 'helium' ),
			'hex'   => '#5cb85c'
		),
		'orange'    => array(
			'label' => esc_html__( 'Orange', 'helium' ),
			'hex'   => '#f0ad4e'
		),
		'dark-gray' => array(
			'label' => esc_html__( 'Dark Gray', 'helium' ),
			'hex'   => '#363636'
		)
	);
}
