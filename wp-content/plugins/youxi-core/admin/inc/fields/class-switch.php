	...
	class Youxi_Switch_Form_Field extends Youxi_Form_Field {
		...
		public function enqueue( $hook ) {
			...
			if( parent::enqueue( $hook ) ) {
				...
				wp_enqueue_script( 'switchery', self::field_assets_url( "plugins/switchery/switchery{$suffix}.js" ), array( 'jquery' ), '0.8.1', true );
				wp_enqueue_style( 'switchery', self::field_assets_url( "plugins/switchery/switchery{$suffix}.css" ), array(), '0.8.1' );
		...
		public function sanitize( $data ) {
			return wp_validate_boolean( $data );
		}
