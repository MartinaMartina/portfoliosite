...
class Youxi_Builder_Manager {
	...
	public function get_builder_settings() {
		...
		/* Get column shortcode */
		$col_shortcode = Youxi_Shortcode::get_column_shortcode();
		...
		$non_widget_shortcodes = array_merge( $non_column_or_widget_shortcodes, array( $col_shortcode ) );
		...
		$rules[ $row_shortcode ] = array(
			'accept' => array( $col_shortcode ), 
			'reject' => $non_column_or_widget_shortcodes
		);
		$rules[ $col_shortcode ] = array(
			'accept' => '*', 
		...
		$settings = array(
			...
			'columnShortcode'           => $col_shortcode, 
			'columnDefaultType'         => Youxi_Shortcode::get_column_default_type(), 
			'rules'                     => $rules, 
	...
	public function admin_enqueue_scripts( $hook ) {
		...
		*/
		...
		if( ! wp_style_is( 'font-awesome', 'registered' ) ) {
			wp_register_style( 'font-awesome', '//maxcdn.bootstrapcdn.com/font-awesome/4.6.2/css/font-awesome.min.css', array(), '4.6.2', 'screen' );
		}
