		...
		<ul class="youxi-repeater-control-list">
			...
			?><li class="youxi-repeater-control-item" data-index="<?php echo esc_attr( $index ) ?>">
				...
				<div class="youxi-repeater-control-item-inside">
					...
					<a href="#" class="youxi-repeater-control-remove-item"><?php esc_html_e( 'Remove', 'helium' ) ?></a>
				</div>
			</li>
			<?php endforeach;

		?></ul>
		<button type="button" class="button-secondary youxi-repeater-control-add-item"><?php esc_html_e( 'Add Item', 'helium' ) ?></button>
		<?php
	}
